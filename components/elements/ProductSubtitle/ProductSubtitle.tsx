...
const ProductSubtitle = ({ subtitleClassName,
  subtitleRectClassName }: IProductSubtitleProps) => {
  const { lang, translations } = useLang()
  const descriptionSlicePosition = lang === 'ru' ? 5 : 2

  return (
    <div className={`${styles.product_subtitle_subtitle} ${subtitleClassName}`}>
      <div className={`${styles.product_subtitle_subtitle_rect} ${subtitleRectClassName}`} />
      <span>
